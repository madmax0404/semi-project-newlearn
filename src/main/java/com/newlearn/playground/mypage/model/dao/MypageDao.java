...
public interface MypageDao {
	...
	int modifyClassSubscription(Map<String, Object> paramMap);

	List<Image> getSlidingImgList(int mypageNo);

	int imgUpload(Image img);

	int mypageImgUpload(Map<String, Object> paramMap);
	...
	int joinClassAsTeacher(Map<String, Object> map);
